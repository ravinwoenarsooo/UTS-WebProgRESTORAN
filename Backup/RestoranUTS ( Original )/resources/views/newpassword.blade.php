...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <form action="/change_password" method="post">
      ...
      <div class="mb-4 ml-4"> 
        <button type="submit" class="flex w-full justify-center rounded-md bg-red-500 px-3 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-red-700 hover:text-red-00 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500">Change Password</button>
      </div>
    </form>
  </div>
</div>
